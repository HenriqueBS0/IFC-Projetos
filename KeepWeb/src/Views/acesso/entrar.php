    ...
    <div class="row mb-5 justify-content-center">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="border border-1 rounded p-3">
                <form id="formulario-entrar" method="POST" action="<?= project_url('entrar')?>">
                    <fieldset>
                        ...
                        <div class="d-grid gap-2 mx-auto">
                            <button id="button-submit" type="button" class="btn btn-lg btn-warning">Entrar</button>
                            <a href="<?= project_url('cadastrar') ?>" type="submit" class="btn btn-lg btn-outline-warning">Casdastrar-se</a>
                        </div>
                    </fieldset>
                </form>
            </div>
